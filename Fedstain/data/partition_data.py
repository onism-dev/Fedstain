...
ALL_DOMAINS = {
    ...
    "came": ["domain_hospital0", "domain_hospital1", "domain_hospital2", "domain_hospital3", "domain_hospital4"],
    "midog": ["Hamamatsu XR", "3D Histech", "Aperio CS2", "Hamamatsu S360"],
}
    ...
    if args.dataset != "minidomainnet":
        ...
        for domain, path in domain_paths.items():
            ...
            for cls in os.listdir(path):
                ...
                all_files[domain].extend(collected)
                all_labels[domain].extend([cls] * len(collected))
    else:
        domain_paths = {
